...
.field private mPartitions:[Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    .line 59
    iput v0, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mSize:I
    ...
    new-array v0, v0, [Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;

    iput-object v0, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mPartitions:[Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;
...
.method public addPartition(Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;)V
    ...
    .line 88
    iget v2, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mSize:I

    iget-object v3, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mPartitions:[Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;
    ...
    new-array v0, v1, [Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;

    .line 91
    .local v0, "newAdapters":[Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;
    iget-object v2, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mPartitions:[Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;

    iget v3, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mSize:I
    ...
    .line 94
    .end local v0    # "newAdapters":[Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;
    ...
    iput v4, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mSize:I
...
.method public areAllItemsEnabled()Z
    ...
    .local v0, "i":I
    :goto_0
    iget v1, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mSize:I

    if-ge v0, v1, :cond_1

    .line 473
    iget-object v1, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mPartitions:[Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;
...
.method protected ensureCacheValid()V
    ...
    .line 165
    iget-boolean v4, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mCacheValid:Z
    ...
    .local v2, "i":I
    :goto_1
    iget v4, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mSize:I

    if-ge v2, v4, :cond_4

    .line 171
    iget-object v4, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mPartitions:[Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;

    aget-object v4, v4, v2

    iget-object v1, v4, Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;->cursor:Landroid/database/Cursor;
    ...
    iget-boolean v4, v4, Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;->hasHeader:Z
    ...
    iget-boolean v4, v4, Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;->showIfEmpty:Z
    ...
    iput v0, v4, Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;->count:I
...
.method public getCursor(I)Landroid/database/Cursor;
    ...
    .prologue
    .line 204
    iget-object v0, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mPartitions:[Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;
...
.method public getItem(I)Ljava/lang/Object;
    ...
    .local v2, "i":I
    :goto_0
    iget v5, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mSize:I

    if-ge v2, v5, :cond_1

    .line 416
    iget-object v5, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mPartitions:[Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;
    ...
    iget-object v0, v5, Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;->cursor:Landroid/database/Cursor;
...
.method public getItemId(I)J
    ...
    .local v2, "i":I
    :goto_0
    iget v7, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mSize:I

    if-ge v2, v7, :cond_1

    .line 442
    iget-object v7, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mPartitions:[Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;

    aget-object v7, v7, v2

    iget v7, v7, Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;->count:I
    ...
    iget-boolean v7, v7, Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;->hasHeader:Z
    ...
    iget v7, v7, Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;->idColumnIndex:I
    ...
    iget-object v0, v7, Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;->cursor:Landroid/database/Cursor;
    ...
    iget v5, v5, Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;->idColumnIndex:I
...
.method public getPartition(I)Lcom/android/contacts/common/list/CompositeCursorAdapter$Partition;
    ...
    .prologue
    .line 150
    iget v0, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mSize:I
...
.method public isEnabled(I)Z
    ...
    :cond_1
    invoke-virtual {p0, v1, v2}, Lcom/android/contacts/common/list/CompositeCursorAdapter;->isEnabled(II)Z
...
.method public removePartition(I)V
    ...
    iput v1, p0, Lcom/android/contacts/common/list/CompositeCursorAdapter;->mSize:I
